...
export class SynFhirApiQE extends cdk.Stack {
    constructor(scope: Construct, id: string, props: SynFhirApiQEProps) {
        ...
        const containerBuildArgs = {
            ...
            ORG_TECHBD_SERVICE_HTTP_GITHUB_AUTHZ_USERS_YAML_URL: envConfig.ORG_TECHBD_SERVICE_HTTP_GITHUB_AUTHZ_USERS_YAML_URL || "",
            ORG_TECHBD_SERVICE_HTTP_GITHUB_API_AUTHN_TOKEN: envConfig.ORG_TECHBD_SERVICE_HTTP_GITHUB_API_AUTHN_TOKEN || "",
        }
        console.log(`fhir tbd devl  containerBuildArgs: ${JSON.stringify(containerBuildArgs)}`)
        ...
        const fhirDockerImage = new ecrAssets.DockerImageAsset(
            ...
            "fhirImage",
            {
                directory: "./synthetic.fhir.api.qualifiedentity.org/containers/hub-prime/", // Adjust this to the path of your Docker context
